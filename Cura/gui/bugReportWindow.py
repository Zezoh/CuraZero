...
class bugReportWindow(wx.Frame):
	def __init__(self, parent):
		...
		version = os.environ['CURAZERO_RELEASE_VERSION']
		...
		s.Add(wx.StaticText(p, -1, _("If you have noticed a problem, please first ensure you are using the latest version of Cura Zero.")), flag=wx.BOTTOM|wx.LEFT|wx.RIGHT, border=5)
		...
		url_github_issues = "https://github.com/curazero/CuraZero/issues"
		...
		s.Add(wx.StaticText(p, -1, _("Then, please attach the 3 files named : 'current_profile.ini', 'mru_filelist.ini', 'preferences.ini'.\n- On Windows, you can find them in ~/.curaZero/%s/.\n- On MacOs, you can find them in ~/Library/Application Support/CuraZero/%s/.\n- On Linux, you can find them in ~/.curaZero/%s/.") % (version, version, version)), flag=wx.BOTTOM|wx.LEFT|wx.RIGHT, border=5)
		s.Add(wx.StaticLine(p), flag=wx.EXPAND|wx.BOTTOM|wx.LEFT|wx.RIGHT, border=5)
